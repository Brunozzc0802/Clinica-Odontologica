...
uses
  uProcedimentos, uProcedimentosRepository, System.Generics.Collections,
  System.SysUtils;
...
type
  ...
  public
    ...
    procedure AdicionarProcedimento(const Nome: string; const Valor: Double;
      const Duracao: TTime);
    procedure AlterarProcedimento(const Id: Integer; const Nome: string;
      const Valor: Double; const Duracao: TTime);
...
procedure TProcedimentosController.AdicionarProcedimento(const Nome: string;
  const Valor: Double; const Duracao: TTime);
var
...
procedure TProcedimentosController.AlterarProcedimento(const Id: Integer;
  const Nome: string; const Valor: Double; const Duracao: TTime);
var
  Procedimento: TProcedimento;
  RepoProc: TProcedimentoRepository;
begin
